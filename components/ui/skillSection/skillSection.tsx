...
export function SkillCard({ className, text, children }: skillCardProps) {
    return (
        <div className={cn("h-full flex grow-0 justify-start items-center rounded-3xl md:rounded-4xl bg-primary-foreground relative contain-paint p-4 gap-4", className)}>
            {children}
