import { Flower_9, Misc_8, Moon_13, Moon_9, Star_8, Triangle_8, Wheel_5 } from "../icons/icons";
...
export default function Hero() {
  return (
    ...
    <div className="flex flex-row flex-wrap w-full gap-2 justify-center items-center">
      ...
      <div className="flex flex-row flex-wrap items-center justify-start text-8xl gap-y-2 gap-x-4">
        <span>Building</span><Star_8 className="size-34"/><span className={cn("text-white italic px-8 py-4 rounded-full flex flex-grow justify-center", styles.orange)}>Experiences</span><Moon_9 className="size-32 hue-rotate-180"/>
        <span className = {cn("text-white px-8 py-4 rounded-full flex flex-grow justify-center", styles.blue)}>Crafting</span><Misc_8 className="size-32 rotate-90"/><Moon_13 className="size-28"/><span>Websites</span>
       <span className="flex flex-row items-center justify-center gap-4"><Triangle_8 className="size-28 rotate-90"/>to Deliver</span><Flower_9 className="size-28"/><span className={cn("text-white font-bold px-8 py-4 rounded-full flex flex-grow justify-center", styles.green)}>impact</span><Wheel_5 className="size-32 rotate-25"/>
      </div>
    </div>
