...
export default function Hero() {
  return (
    ...
    //   <h2 className={`flex text-9xl font-black px-3 py-4 lg:px-12 lg:py-10.5 items-center justify-center`}>Doodle visions. Design with passion. Develop with precision. Deliver impact.</h2>
    // </div>
    <div className="flex">
      <div className={`${styles.hero} text-2xl lg:text-5xl font-extrabold flex flex-col gap-4 lg:gap-6 text-white [&>*]:justify-center [&>*]:items-center [&>*]:flex-wrap`}>
        <div className="flex gap-4 lg:gap-6">
