...
export default function MyWork() {
    ...
    return (<div className="flex flex-col gap-6" ref={container}>
      ...
      <CardGrid className="!grid-cols-1">
        <Card className="fade-up-card bg-gradient-to-br from-[#06D6A0] to-[#007E5D]" title="Bounce Back Learning App" subtitle="UX Design, EdTech" description="Learning, earning, managing, and connecting, all in one crypto-powered platform." cta="View Project" link="/docs/recent-work/bounce-back-learning">
        ...
        <Card className="fade-up-card bg-gradient-to-br from-[#63b1ff] to-[#1f7cda]" title="Lynk" subtitle="UX Design, Product Design" description="Lynk connects people with local activities and communities to fight social isolation." cta="View Project" link="/docs/recent-work/lynk">
        ...
        <Card className="fade-up-card bg-gradient-to-br from-[#000] to-[#141414]" title="Bounce Back Digital" subtitle="Branding" description="Bounce Back Digital, a digital agency and fintech startup that focuses on providing innovative solutions in the digital space." cta="View Project" link="/docs/recent-work/bounce-back-digital-branding" dark>
