...
export default function Introduction() {
    return (<div className="flex flex-col md:flex-row gap-4 lg:gap-16 items-center text-2xl lg:text-5xl leading-snug">
