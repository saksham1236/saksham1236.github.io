      ...
      >
        <DialogTrigger asChild>
          <div className="relative max-w-md flex-1 cursor-pointer">
            ...
            <Input
              className="bg-background h-9 w-full rounded-full border-2 border-[#536a8d50] pr-4 pl-10 text-sm md:w-full"
              placeholder="Search"
              type="search"
            />
          </div>
        ...
        <DialogContent className="top-[45%] max-w-xs p-0 sm:top-[38%] sm:max-w-lg">
          ...
          <DialogHeader>
            <input
              ...
              placeholder="Search..."
              autoFocus
              className="h-14 border-2 bg-transparent px-4 text-[15px] outline-none"
            />
          </DialogHeader>
