...
export default function VideoPlayer({ src, title, className, autoplay, loop, muted = true, }) {
    ...
    return (<MediaPlayer className={cn("video-player ring-media-focus aspect-video w-full overflow-hidden rounded-lg bg-slate-900 font-sans text-white data-[focus]:ring-4", className)} onProviderChange={onProviderChange} 
    // controls
