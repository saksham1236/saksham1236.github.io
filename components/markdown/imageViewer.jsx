...
export default function ImageViewer({ imageUrl, altText, }) {
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogTrigger asChild>
          <div className="group relative cursor-pointer transition-opacity duration-200 hover:opacity-80">
            <Image src={imageUrl} alt={altText} className="w-full rounded-3xl md:rounded-4xl" width={1200} height={1200} onContextMenu={(e) => {
            e.preventDefault();
        }}/>
