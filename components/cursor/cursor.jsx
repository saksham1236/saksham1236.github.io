...
export default function Cursor() {
    function useMouseAndHover() {
        ...
        const [customprop, setCustomProps] = useState({
            top: null,
            left: null,
            height: 32,
            width: 32,
    ...
    const cursorStyles = cn("transition-transform transition-gpu custom-cursor z-[40] border-4 border-sky-300 dark:border-white bg-white/50", isHover
        ? `transition-transform transition-gpu duration-150`
        : "`transition-transform transition-gpu rounded-[200px] h-4 w-4");
    const offset = 12;
