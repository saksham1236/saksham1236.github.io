...
<CarouselView autoscroll infinite className = "mt-8" aspect = "aspect-16/9 md:aspect-25/9" controls = {false}>
...
## 🛠️ What did I do?
<div className='tag-group'><Tag>Visual Design</Tag><Tag>High Fidelity Prototype</Tag><Tag>Design System</Tag></div>
## 🧩 The Problem
### A Novelty Product
