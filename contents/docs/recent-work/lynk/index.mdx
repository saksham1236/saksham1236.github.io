...
<Note className="note-bevel relative">
  ...
  <span className = "text-xs"> User Persona inspired by this study here [https://www.carolinapizatto.com/reviving-personas](https://www.carolinapizatto.com/reviving-personas)</span>
</Note>
<CardGrid className="xl:!grid-cols-2">
<Note>
