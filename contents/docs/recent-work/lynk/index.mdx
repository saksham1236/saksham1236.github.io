...
<CardGrid className = "!grid-cols-1 gap-16 prose-p:!mb-0 prose-headings:!mt-0 items-center py-16">
  <div>
    ### The Foundation
...
<div className='py-16'>
<CardGrid className = "!grid-cols-2 gap-16 prose-p:!mb-0 prose-headings:!mt-0 items-center py-16">
  <div>
...
<CardGrid className = "lg:!grid-cols-2 gap-16 prose-p:!mb-0 prose-headings:!mt-0 items-center py-16">
  <div>
